...
- Ran comparative evaluations of naive and policy-aware scaffold LLM agents, identifying `scaffold_naive × mandarin_pragmatic` as the highest observed failure rate among tested cells and showing that policy-aware prompting lowered observed unauthorized concessions in this pilot.
