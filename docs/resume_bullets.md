...
- Ran comparative evaluations of naive and policy-aware OpenAI-based agents, identifying `openai_naive_agent × mandarin_pragmatic` as the highest-risk failure mode and showing that policy-aware prompting sharply reduced unauthorized concessions.
